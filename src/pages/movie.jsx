...
//   return (
//     <>
//       <div className="bg-[#181C24] w-screen h-screen p-5 flex justify-between items-center flex-row">
//         <div className="rounded-lg flex flex-col items-start justify-start mx-[7vw]">
...
//             alt="Movie Poster"
//             className="mt-5 rounded-lg shadow-lg w-1/2 "
//           />
//         </div>
//       </div>
//     </>
          ...
          <div className="md:w-1/2  flex flex-col gap-15">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                ...
                ex placerat volutpat. Praesent consectetur vulputate pulvinar,
                gravida id quam. Fusce rutrum consequat ligula. Fusce ac nisi
                non justo aliquet ultrices. Mi turpis porta risus, dignissim
                lacinia velit felis a quam. In auctor ut tortor sit amet
                rhoncus.
              </p>
            ...
            {activeTab === "about" && (
              <div>
                ...
                <p className="text-gray-400 mb-4">
                  ...
                  Leo Brewer volutpat. Praesent consectetur vulputate pulvinar,
                  gravida id quam. Et Duis Aute Irure Dolor.
                </p>

                <h3 className="font-bold mb-2">Rating</h3>
                <p className="text-gray-400">
                  Fugiat nulla dolor Sit Amet, Consectetur Adipiscing Elit. Sed
                  Leo Brewer volutpat. Praesent consectetur vulputate pulvinar,
                  gravida id quam. Et Duis Aute Irure Dolor.
                </p>
              </div>
